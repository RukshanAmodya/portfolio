                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    <AnimateOnScroll>
                        ...
                        <div className="space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed">
                            <p>මම රුක්ෂාන් අමෝද්‍ය, ශ්‍රී ලංකාව පදනම් කරගත් මෘදුකාංග ඉංජිනේරුවෙක්. නවීන තාක්ෂණයන් භාවිතා කරමින්, පරිශීලක-හිතකාමී සහ ඉහළ ක්‍රියාකාරීත්වයකින් යුතු වෙබ් සහ ජංගම යෙදුම් නිර්මාණය කිරීම මගේ විශේෂත්වයයි.</p>
                            <p>සෑම ව්‍යාපෘතියක්ම සාර්ථක කරගැනීම සඳහා පාරිභෝගිකයා සමග සමීපව කටයුතු කරමින්, ඔවුන්ගේ අදහස් යථාර්ථයක් බවට පත්කිරීමට මම කැපවී සිටිමි.</p>
                        </div>
                        <h3 className="text-2xl font-bold text-gray-800 dark:text-white mt-10 mb-5">තාක්ෂණික කුසලතා</h3>
                        <div className="flex flex-wrap gap-4">
                            {skills.map(skill => (
                                <div key={skill.name} className="flex items-center gap-2 bg-gray-100 dark:bg-gray-800 px-3 py-2 rounded-lg">
...
<AnimateOnScroll delay={200}>
  <div
    className="
      relative
      p-0                             /* ✏️ EDIT padding (currently zero) */
      max-w-[290px]                   /* ✏️ EDIT max width of the whole card */
      mx-auto
      rounded-2xl
      bg-gradient-to-br from-blue-200 to-purple-300
      dark:from-blue-800 dark:to-purple-900
      shadow-2xl
      transform scale-110             /* ✏️ EDIT manual scale (e.g. scale-100, scale-125) */
  ...
  >
    <img
      ...
      className="
        rounded-xl
        w-180                           /* ✏️ EDIT actual image width (w-32, w-40, etc.) */
        h-auto
        mx-auto
      "
      loading="lazy"
...
const ContactSection = () => {
    const contacts = [
        { title: 'LinkedIn', handle: 'Rukshan-Amodya', icon: Linkedin, link: 'https://www.linkedin.com/in/rukshan-amodya/' },
        { title: 'GitHub', handle: 'RukshanAmodya', icon: Github, link: 'https://github.com/RukshanAmodya' },
        { title: 'Email', handle: 'nmr.amodya@gmail.com', icon: Mail, link: 'mailto:nmr.amodya@gmail.com' },
        { title: 'Phone', handle: '+94 76 860 5501', icon: Phone, link: 'tel:+94768605501' },
    ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-gray-400 text-sm">
                        <li className="flex items-center gap-2"><Mail size={16}/> nmr.amodya@gmail.com</li>
                        <li className="flex items-center gap-2"><Users size={16}/> Horana, Sri Lanka</li>
                    </ul>
                </div>
                <div>
                    <h4 className="font-semibold text-lg mb-4">Follow Me</h4>
                    <div className="flex space-x-4">
                        <a href="https://www.linkedin.com/in/rukshan-amodya/" target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-700 rounded-full hover:bg-blue-600 transition-colors"><Linkedin size={20} /></a>
                        <a href="https://github.com/RukshanAmodya" target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-700 rounded-full hover:bg-blue-600 transition-colors"><Github size={20} /></a>
                    </div>
                </div>
            </div>
            <div className="mt-12 pt-8 border-t border-gray-700 text-center text-gray-500 text-sm">
                <p>&copy; {new Date().getFullYear()} Rukshan Amodya. All Rights Reserved. Designed & Developed with <a href='https://codd.pirm.lk'>Coding Divers</a>.</p>
            </div>
        </div>
    </footer>
);
