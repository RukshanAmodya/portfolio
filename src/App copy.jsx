            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                ...
                >
                    <div className="relative">
                        ...
                        <img src="/assets/rukshan-face.png" alt="Rukshan Amodya" className="relative rounded-full shadow-2xl mx-auto border-4 border-slate-200 dark:border-gray-800 w-64 h-64 md:w-80 md:h-80 object-cover"/>
                    </div>
                </motion.div>
...
//https://placehold.co/400x400/0f172a/ffffff?text=RA
...
const CertificationsSection = () => {
    ...
    const CertificationCard = ({ cert }) => (
        <motion.div
            className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col h-full text-center group"
        ...
        >
            <div className="flex-grow">
                <img 
                    ...
                    className="w-32 h-32 rounded-full mx-auto mb-4 border-4 border-slate-200 dark:border-gray-700 object-cover transition-transform duration-300 group-hover:scale-105"
            ...
            <div className="mt-auto pt-4">
                <p className="text-xs text-slate-400 dark:text-slate-500 mb-3">{cert.date}</p>
                <a
                    href={cert.verificationUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center gap-2 text-sm font-semibold text-blue-600 dark:text-blue-500 hover:underline"
                >
                    <CheckCircle size={16} />
                    Verify Credential
                </a>
