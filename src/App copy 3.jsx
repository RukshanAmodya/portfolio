      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-12 items-center">
        <AnimateOnScroll className="md:col-span-3">
          ...
          <div className="space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <p>
              සෑම ව්‍යාපෘතියක්ම සාර්ථක කරගැනීම සඳහා පාරිභෝගිකයා සමග සමීپව කtaයුතු කරමින්, ඔවුන්ගේ අදහස් යථාර්ථයක් බවට පත්කිරීමට මම කැපවී සිටිමි.
            </p>
          </div>
...
const ProjectsSection = () => {
    const projects = [
        { title: 'E-Commerce Platform', desc: 'සම්පූර්ණ অনলাইন වෙළඳසැලක් සඳහා වූ විසඳුම.', img: 'https://placehold.co/600x400/e2e8f0/334155?text=Project+1', tags: ['React', 'Node.js', 'MongoDB'] },
